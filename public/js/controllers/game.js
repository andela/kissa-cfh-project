angular.module('mean.system')
  .controller('GameController', ['$scope', 'game', 'dataFactory', '$http', '$timeout', '$location', '$modal', 'MakeAWishFactsService', function ($scope, game, dataFactory, $http, $timeout, $location, $modal, MakeAWishFactsService) {
